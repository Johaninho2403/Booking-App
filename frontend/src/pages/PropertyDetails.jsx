      ...
      <div>
        <div className="grid grid-cols-1 sm:grid-cols-[3fr_2fr] gap-2">
          <div className="sm:h-[90vh] sm:overflow-y-auto">
            ...
            <div className="my-8 flex justify-between">
              <div className="flex flex-col gap-4">
                <h1 className="text-xl text-[#3c3b3b]">{post.title}</h1>
                <div className="flex gap-1">
                  <img src="/pin.png" alt="pin" className="w-4" />
                  <p className="text-slate-400 text-sm">{post.adress}</p>
                </div>
              ...
              <div className="flex flex-col py-2 px-6 rounded-lg bg-[#FEE9B9] items-center gap-3">
                ...
                />
                <p className="text-xl font-medium">{post.user.username}</p>
              </div>
            </div>
            <p
              className="text-sm text-justify text-[#3c3b3b]"
          ...
          <div className="bg-[#fcf5f3] min-h-[90vh] px-4">
            ...
            <div className="flex justify-between mt-2">
              <div className="bg-white flex items-center gap-2 px-2 py-2 rounded-md">
                ...
                <span className="text-sm">
                  {Math.round(post.size / 10.7639104)}sqm(
                  {post.size}sqft)
                </span>
              </div>
              <div className="bg-white flex items-center gap-2 px-2 py-2 rounded-md">
              ...
              {post.school && (
                <div className="flex gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-sm">{post.school}</div>
                  </div>
                </div>
              )}
              {post.bus && (
                <div className="flex gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-sm">{post.bus}</div>
                  </div>
                </div>
              )}
              {post.restaurant && (
                <div className="flex gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-sm">{post.restaurant}</div>
                  </div>
                </div>
              )}
            </div>
            ...
            <div
              className={`mt-2 h-40 ${showSlider ? "hidden" : ""} rounded-lg`}
            >
              <Map places={[post]} />
            </div>
