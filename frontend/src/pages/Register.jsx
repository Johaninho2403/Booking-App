...
const Register = () => {
  ...
  return (
    <div className="flex justify-center items-center h-[90vh]">
      <form onSubmit={handleSubmit} className="flex flex-col gap-y-4 w-full max-w-75">
        ...
        <Link to={'/login'} className="underline font-light self-start">Do you have an account ?</Link>
      </form>
    </div>
  );
};
